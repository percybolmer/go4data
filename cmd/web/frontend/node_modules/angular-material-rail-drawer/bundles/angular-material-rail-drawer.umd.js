(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material/sidenav'), require('@angular/animations'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/bidi')) :
    typeof define === 'function' && define.amd ? define('angular-material-rail-drawer', ['exports', '@angular/core', '@angular/material/sidenav', '@angular/animations', 'rxjs', 'rxjs/operators', '@angular/cdk/bidi'], factory) :
    (global = global || self, factory(global['angular-material-rail-drawer'] = {}, global.ng.core, global.ng.material.sidenav, global.ng.animations, global.rxjs, global.rxjs.operators, global.ng.cdk.bidi));
}(this, (function (exports, core, sidenav, animations, rxjs, operators, bidi) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function sidebarAnimationOpenGroup(animationDuration, maxWidth) {
        ...
        return animations.group([
            animations.query('@iconAnimation', animations.animateChild(), { optional: true }),
            animations.query('@labelAnimation', animations.animateChild(), { optional: true }),
            animations.animate(animationDuration + " ease-in-out", sidebarOpen(maxWidth))
        ]);
    }
    function sidebarAnimationCloseGroup(animationDuration, minWidth) {
        ...
        return animations.group([
            animations.query('@iconAnimation', animations.animateChild(), { optional: true }),
            animations.query('@labelAnimation', animations.animateChild(), { optional: true }),
            animations.animate(animationDuration + " ease-in-out", sidebarClose(minWidth))
        ]);
    }
    ...
    var MatDrawerRailDirective = /** @class */ (function () {
        ...
        _dir) {
            ...
            this._dir = _dir;
            this.onDestory = new rxjs.Subject();
        ...
        MatDrawerRailDirective.prototype.ngOnInit = function () {
            ...
            this.drawer.closedStart.pipe(operators.takeUntil(this.onDestory)).subscribe(function () {
                _this.closeMenu();
            });
            this.drawer._closedStream.pipe(operators.takeUntil(this.onDestory)).subscribe(function () {
                _this.renderer2.setStyle(_this.el.nativeElement, 'visibility', 'visible');
            });
            this.drawer.openedStart.pipe(operators.takeUntil(this.onDestory)).subscribe(function () {
        ...
        MatDrawerRailDirective.ctorParameters = function () { return [
            ...
            { type: core.Renderer2 },
            { type: sidenav.MatSidenav, decorators: [{ type: core.Host }, { type: core.Self }, { type: core.Optional }] },
            { type: sidenav.MatDrawer, decorators: [{ type: core.Host }, { type: core.Self }, { type: core.Optional }] },
            { type: sidenav.MatSidenavContainer, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return sidenav.MatSidenavContainer; }),] }, { type: core.Optional }] },
            { type: sidenav.MatDrawerContainer, decorators: [{ type: core.Inject, args: [core.forwardRef(function () { return sidenav.MatDrawerContainer; }),] }, { type: core.Optional }] },
        ...
        MatDrawerRailDirective = __decorate([
            ...
            __param(4, core.Host()), __param(4, core.Self()), __param(4, core.Optional()),
            __param(5, core.Inject(core.forwardRef(function () { return sidenav.MatSidenavContainer; }))), __param(5, core.Optional()),
            __param(6, core.Inject(core.forwardRef(function () { return sidenav.MatDrawerContainer; }))), __param(6, core.Optional()),
    ...
    exports.DrawerRailModule = DrawerRailModule;
    exports.MatDrawerRailDirective = MatDrawerRailDirective;
    exports.miniConfig = miniConfig;
    exports.sidebarAnimationCloseGroup = sidebarAnimationCloseGroup;
    exports.sidebarAnimationOpenGroup = sidebarAnimationOpenGroup;
...
//# sourceMappingURL=angular-material-rail-drawer.umd.js.map
