...
func init() {
	register.Register("WriteFile", NewWriteFileAction())
}

// NewWriteFileAction generates a new WriteFile action
func NewWriteFileAction() *WriteFile {
	act := &WriteFile{
...
func (a *WriteFile) GetActionName() string {
	return a.Name
}
