// Package terminal is generated by actiongenerator tooling
...
var (
	...
	ErrEmptyCommand = errors.New("cannot run this action without a command set in configuration, also make sure ValidateConfiguration is run")
)

func init() {
	register.Register("ExecCMD", NewExecCMDAction())
}

// NewExecCMDAction generates a new ExecCMD action
func NewExecCMDAction() *ExecCMD {
	act := &ExecCMD{
...
func (a *ExecCMD) GetActionName() string {
	return a.Name
}
