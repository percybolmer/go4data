...
Ext.define('Ext.pivot.feature.PivotStore', {
    ...
    processGroupOutlineWithChildren: function(config) {
        ...
        hasSummaryData =
            (!group.expanded || (group.expanded && matrix.rowSubTotalsPosition === 'first'));
    ...
    doExpandCollapse: function(key, oldRecord) {
        ...
        gridMaster.fireEvent(
            (group.node.expanded ? 'pivotgroupexpand' : 'pivotgroupcollapse'), gridMaster, 'row',
            group.node
        );
    },
