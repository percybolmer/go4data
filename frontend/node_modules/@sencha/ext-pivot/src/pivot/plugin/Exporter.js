    ...
    getColumnHeaders: function(columns, config) {
        ...
        for (i = 0; i < length; i++) {
            ...
            if (doExtract) {
                ...
                obj = {
                    text: (col.subTotal && col.group &&
                           col.group.expanded ? col.group.getTextTotal() : col.text)
                };
                ...
                if (col.columns) {
                    ...
                    obj.style = col.dimension
                        ? this.getExportStyle(col.dimension.getExportStyle(), config)
                        : null;
                }
