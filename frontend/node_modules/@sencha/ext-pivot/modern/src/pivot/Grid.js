...
Ext.define('Ext.pivot.Grid', {
    ...
    destroy: function() {
        ...
        Ext.destroy(me.matrixRelayedListeners, me.matrixListeners, me.headerCtListeners,
                    me.lockedHeaderCtListeners);
            ...
            if (column.group && column.xgrouped) {
                ...
                if (column.subTotal) {
                    column.text = column.group.expanded
                        ...
                        : Ext.String.format(
                            '<div class="' + Ext.baseCSSPrefix + 'pivot-grid-group-icon ' +
                            Ext.baseCSSPrefix + 'font-icon"></div>' +
                ...
                column.xexpandable =
                    column.subTotal ? !column.group.expanded : column.group.expanded;
    ...
    getStateProperties: function() {
        return ['viewLayoutType', 'rowSubTotalsPosition', 'rowGrandTotalsPosition',
                'colSubTotalsPosition', 'colGrandTotalsPosition', 'aggregate', 'leftAxis',
