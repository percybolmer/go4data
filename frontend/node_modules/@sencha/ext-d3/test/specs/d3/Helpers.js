(Ext.isIE10m ? xtopSuite : topSuite)("Ext.d3.Helpers", ['Ext.d3.*'], function() {
    ...
    describe('unitMath', function() {
        it('should add', function() {
            ...
            value = Ext.d3.Helpers.unitMath('15.5px', '+', 15.5);
            expect(value).toBe('31px');
            
            value = Ext.d3.Helpers.unitMath('10em', '+', 10);
        ...
        it('should subtract', function() {
            ...
            value = Ext.d3.Helpers.unitMath('15.5px', '-', 5.5);
            expect(value).toBe('10px');
            
            value = Ext.d3.Helpers.unitMath('10em', '-', 9);
        ...
        it('should multiply', function() {
            ...
            value = Ext.d3.Helpers.unitMath('13.5px', '*', 2);
            expect(value).toBe('27px');
            
            value = Ext.d3.Helpers.unitMath('10em', '*', 1.5);
        ...
        it('should divide', function() {
            ...
            value = Ext.d3.Helpers.unitMath('20px', '/', 2);
            expect(value).toBe('10px');
            
            value = Ext.d3.Helpers.unitMath('30em', '/', 3);
