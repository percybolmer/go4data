...
function runAppUpgrade(proj) {
    var basedir = proj.getProperty("basedir"),
        ...
        appPath = resolvePath(proj.getProperty("args.path")),
    ...
    // v3 app
        ...
        var appJsonPath = resolvePath(appPath,"app.json"),
            appJsonData = FileUtil.readFile(appJsonPath) + '';
        appJsonData = appJsonData.replace(/^\{/, "{\n" +
            "    \"framework\": \""+frameworkName+"\","
        );
        FileUtil.writeFile(appJsonPath, appJsonData);
