topSuite("Ext.grid.LockedGrid", [
    ...
    function makeGrid(cfg, options) {
        ...
        grid = new Ext.grid.LockedGrid(Ext.apply({
    ...
    describe("columns", function() {
        ...
        describe("menu", function() {
            ...
            it("should not show the region if it's nulled out", function() {
                ...
                expect(m.getItems().getCount()).toBe(2);
                expect(m.getItems().getAt(0).getText()).toBe(getRegion('left').getMenuLabel());
                expect(m.getItems().getAt(1).getText()).toBe(getRegion('center').getMenuLabel());
            });
        ...
        describe("after construction", function() {
            ...
            describe("changes to unlocked side", function() {
                ...
                it("should update when adding a column from right", function() {
                    ...
                    var centerAfterWidth, leftInitialWidth, centerInitialWidth, leftAfterWidth;
                ...
                it("should not scroll on pinned header of other regions when scrolling on one", function() {
                    ...
                    var colf1 = colMap.colf1,
                        center = getGrid('center').getScrollable(),
                        centerHeaderScroll,
                        leftHeaderScroll,
                    ...
                    expect(getGrid('center').getGrouped()).toBeTruthy();

                    centerHeaderScroll = getGrid('center').getPinnedHeader().getScrollable();
                    leftHeaderScroll = getGrid('left').getPinnedHeader().getScrollable();
