/**
 * Ext.tab.Bar is used internally by {@link Ext.tab.Panel} to create the bar of tabs 
 * that appears at the top of the tab panel. It can also be used as a standalone component 
 * to recreate the look and feel of tabs.
 */
Ext.define('Ext.tab.Bar', {
    ...
    applyActiveTab: function(newActiveTab, oldActiveTab) {
        ...
        newTabInstance = this.parseActiveTab(newActiveTab);
