...
__rt_setDynamic("$nightly_shade", __rt_getGlobalDefault("$nightly_shade") || __ColorRGBA.fromHex("#22191a"), 1);
__rt_setDynamic("$base-color", __rt_getGlobalDefault("$base_color") || __rt_get("$nightly_shade"), 2);
